...
let message = "I log my first message!";
...
function logMyInfo(nameTwo, age) {
  console.log("My name is " + nameTwo + ". I am " + age + " years old!");
}

// === TEST YOURSELF ===
// Once you're finished run the test with "npm run test-1"
// If the test has all testslogm passed, switch to the next exercise file
